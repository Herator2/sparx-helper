...
TimeSpent = time.time()  # Time You Have Spent On A Question
BookworkCode = "b10"  # THIS IS TO PREVENT CRASH IF FUNC 3 IS USED WITHOUT A PAST CODE
MainLoop = "Y"


def time_convert(sec):
	file2 = open(TIME_DIRECTORY + BookworkCode, "a")
	sec = round(sec, 0)
	file2.writelines("{0}".format(sec))
	file2.close()
...
# Change this to where you want to save time logs
TIME_DIRECTORY = "Documents/Python/SparksMaths/DATA/LOGS/TIME-LOGS/"
